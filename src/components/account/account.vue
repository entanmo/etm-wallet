  ...
  <div class="account">
    <div class="list">
        <ul>
            ...
            <li class="phone"><span>{{$t('account.info.address')}}：</span><span id="address" >{{accounts.address}}<a-icon title="复制"  type="copy" class="copy copyAddress"  data-clipboard-target="#address" @click="copyAddress" ></a-icon></span>
